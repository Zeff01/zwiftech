  ...
  return (
    <section className="flex flex-col gap-y-12 w-full">
      <div className="flex flex-col items-center gap-y-4">
        <p className="text-lg sm:text-xl font-bold text-center">Our Passionate team of creative professionals</p>
      ...
      <div className="py-16 flex flex-col gap-y-3">
        <h2 className="font-bold text-3xl sm:text-4xl text-custom-purple text-center sm:text-start">Connect With Us</h2>
