...
export default function MissionVision() {
  ...
  return (
    <section
      ...
      ref={sectionRef}
      className="relative w-full bg-gradient-to-b from-white to-gray-100 py-24 px-6 sm:px-6 overflow-hidden">
      <BackgroundImage
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        <motion.div
          ...
          <h4 className="text-2xl text-[#6150eb] font-medium tracking-wide">What we believe</h4>
          <h2 className="text-4xl lg:text-[63px] font-bold text-[#6150eb] leading-none">
