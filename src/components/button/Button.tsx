...
const buttonVariants = cva(
  "w-[150px] sm:w-[182px] inline flex items-center justify-center whitespace-nowrap rounded-full px-4 py-2 sm:px-6 sm:py-3 shadow-md",
  {
    variants: {
      variant: {
        default: "bg-custom-purple text-white",
        outline: "border border-custom-black text-black",
        icon: "w-[50px] sm:w-[80px] h-[50px] sm:h-[80px] px-0 py-0 bg-custom-purple text-white",
